...
@section('content')
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="hero__categories">
                        ...
                        <ul>
                            @foreach ($cat as $cat)
                            <li><a href="{{ url('category', ['id'=>$cat->kd_cat]) }}">{{$cat->nama_cat}}</a></li>
                            @endforeach
                ...
                <div class="col-lg-9">
                    ...
                    <div class="hero__item set-bg" data-setbg="img/hero/ban.jpg">
                        <div class="hero__text" style="color: aliceblue;">
                            ...
                            <a href="{{ url('listproduct', []) }}" class="primary-btn">SHOP NOW</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="categories__slider owl-carousel">
                    ...
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="img/categories/cat-3.jpg">
                            <h5><a href="#">Black Pepper</a></h5>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="img/categories/cat-4.jpg">
                            <h5><a href="#">White Pepper</a></h5>
                        </div>
                    </div>
                    <div class="col-lg-3">
    ...
    <section class="featured spad">
        <div class="container">
            ...
            <div class="row featured__filter">
                @foreach ($postinganbarang as $item)

                <div class="col-lg-3 col-md-4 col-sm-6 mix oranges fresh-meat">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="{{$item->file_barang}}">
                        ...
                        <div class="featured__item__text">
                            <h6><a href="{{ url('/listproduct/item', ['id'=>$item->kd_item]) }}">{{$item->nama_item}}</a></h6>
    ...
    <section class="from-blog spad">
        <div class="container">
            ...
            <div class="row">
                @foreach ($postinganblog as $postinganblog)

                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="blog__item">
                        <div class="blog__item__pic">
                            <img src="{{ url($postinganblog->file, []) }}" alt="">
                        </div>
                        <div class="blog__item__text">
                            <ul>
                                <li><i class="fa fa-calendar-o"></i> {{$postinganblog->created_at}}</li>
                                <li><i class="fa fa-comment-o"></i> 5</li>
                            </ul>
                            <h5><a href="{{ url('blog/detail', ['id'=>$postinganblog->kd_blog]) }}">{{$postinganblog->judul_blog}}</a></h5>
